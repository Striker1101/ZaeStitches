         ...
         <div class="rey-searchPanel-inner">
             ...
             <nav class="rey-searchPanel__qlinks" aria-label="Search Menu" data-lazy-hidden>
                 ...
                 <ul data-menu-qid="1702" id="menu-quicklinks" class="rey-searchMenu list-unstyled">
                     ...
                     <li id="menu-item-<?php echo $category->id; ?>"
                         class="menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-<?php echo $category->id; ?> o-id-<?php echo $category->id; ?>">
                         <a href="<?php echo route('shop', ['category' => $category->name]); ?>">
