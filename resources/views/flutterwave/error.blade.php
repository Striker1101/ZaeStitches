 ...
 @section(section: 'content')
     ...
     <body class="flex items-center justify-center h-screen" style="background-color: #0A0E27;">

         <div class="max-w-lg mx-auto p-8 bg-white shadow-lg rounded-lg text-center my-5">
             <div class="flex justify-center mb-4">
                 <div class="bg-[#FB9129] rounded-full p-6 flex items-center justify-center">
                     <img class="w-16 h-16 mx-auto" src="https://img.icons8.com/fluency/48/cancel.png"
                         alt="Payment Error Icon" />
                 </div>
             </div>
             <h1 class="text-3xl font-semibold mb-4 text-[#0A0E27]">Payment Failed!</h1>
             <p class="text-gray-600 mb-6">We encountered an issue with your payment. Please try again or contact support.
             </p>
             <a href="/retry-payment"
                 class="inline-block py-3 px-6 bg-[#FB9129] text-white font-semibold rounded-lg shadow-md hover:bg-[#D17A24] transition duration-300">Retry
                 Payment</a>
         </div>
