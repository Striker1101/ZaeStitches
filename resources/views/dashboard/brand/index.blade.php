<x-layouts.app :title="__('Brands')">
    <div class="container mx-auto p-4">
        <div class="flex justify-between items-center mb-4">
            ...
            <a href="{{ route('dashboard.brand.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">
                + New Brand
            </a>
        </div>
                    ...
                    <tr class="border-t border-gray-200">
                        ...
                        <td class="px-4 py-2">{{ $brand->name }}</td>
                         ...
                         <td class="px-4 py-2 flex gap-2">
                            <a href="{{ route('dashboard.brand.edit', $brand) }}" class="text-blue-600 hover:underline">Edit</a>
