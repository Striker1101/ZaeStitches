...
(self.webpackChunkelementorFrontend =
    ...
    [941],
    {
                        ...
                        switch (n) {
                            case "right":
                                this.forceSliderToShowNextSlideWhenOnLast(t, r),
                                    this.addClassToSwiperContainer(
                                        "offset-right"
                                    );
                                break;
                            case "left":
                ...
                (e.exports = elementorModules.ViewModule.extend({
                    ...
                    getElementSettings(e) {
                        ...
                        if (this.isEdit && r) {
                            ...
                            s ||
                                ((s = elementorFrontend.config.elements.keys[
                                    i
                                ] =
                                    []),
                                jQuery.each(e.controls, (e, t) => {
                                    (t.frontend_available ||
                                        t.editor_available) &&
                                        s.push(e);
                                })),
                                jQuery.each(
                    ...
                    getEditSettings(e) {
                        ...
                        return (
                            this.isEdit &&
                                (t =
                                    elementorFrontend.config.elements
                                        .editSettings[this.getModelCID()]
                                        .attributes),
                            this.getItems(t, e)
                        );
                    },
            ...
            const Module = function () {
                ...
                (this.getItems = function (e, t) {
                    ...
                    (this.setSettings = function (t, n, s) {
                        if ((s || (s = i), "object" == typeof t))
                            return e.extend(s, t), r;
                        const o = t.split("."),
                            a = o.splice(0, 1);
                        return o.length
                            ? (s[a] || (s[a] = {}),
                              r.setSettings(o.join("."), n, s[a]))
                            : ((s[a] = n), r);
                    }),
                    ...
                    for (u in t) {
                        if (
                            ...
                            (d = e.dontCallGetSet
                                ? (h = i(r, u)) && h.value
                                : r[u]),
                            !l(g ? u : f + (m ? "." : "#") + u, e.forced) &&
                                void 0 !== d)
                        ) {
                            if (typeof p == typeof d) continue;
                            c(p, d);
                        }
                        (e.sham || (d && d.sham)) && s(p, "sham", !0),
                            o(r, u, p, e);
                    }
            };
        },
        ...
        169: (e, t, r) => {
            ...
            var n = r(4762),
                ...
                b = (e.exports = function (e, t, r) {
                    ...
                    return (
                        o(n, "source") ||
                            (n.source = v(w, "string" == typeof t ? t : "")),
                        e
                    );
                });
            ...
            t.f =
                n && !i
                    ...
                    : function defineProperties(e, t) {
                          o(e);
                          for (
                              var r, n = a(t), i = c(t), l = i.length, u = 0;
                              l > u;
        ...
        1: (e, t, r) => {
            ...
            e.exports = function (e) {
                return (
                    s(u, e) || (u[e] = a && s(l, e) ? l[e] : d("Symbol." + e)),
                    u[e]
                );
            };
        },
            ...
            var n = r(8612),
                ...
                d = c(function () {
                    for (
                        ...
                        if (((t = e.value), l(r, n, [t, this.counter++], !0)))
                            return t;
                    }
                });
            n(
