    ...
    class RocketLazyLoadScripts {
                    ...
                    if ("attributes" === i.type) {
                        ...
                        t &&
                            ...
                            (i.target.setAttribute(
                                "data-rocket-" + i.attributeName,
                                t
                            ),
                            (i.target["rocket" + i.attributeName] =
                                new Function("event", t)),
                            i.target.setAttribute(i.attributeName, e));
                    }
                    "childList" === i.type &&
                        i.addedNodes.forEach((t) => {
                            if (t.nodeType === Node.ELEMENT_NODE)
                                for (const i of t.attributes)
                                    this.attributeEvents.includes(i.name) &&
                                        i.value &&
                                        "" !== i.value &&
                                        (t.setAttribute(
                                            "data-rocket-" + i.name,
                                        ...
                                        (t["rocket" + i.name] = new Function(
                                            "event",
                                            i.value
                                        )),
                                        t.setAttribute(i.name, e));
                        });
                }
            })),
        ...
        F(t) {
            "all" === t &&
                ...
                (EventTarget.prototype.removeEventListener =
                    this.originalRemoveEventListener)),
                (this.savedEventListeners = this.savedEventListeners.filter(
                    (e) => {
                        let i = e.type,
                            o = e.target || window;
                        return (
                            ...
                            ("windowLoad" === t &&
                                ...
                                "readystatechange" !== i &&
                                "pageshow" !== i) ||
                            (this.B(i, o) && (i = "rocket-" + i),
                            e.remove
                                ? o.removeEventListener(i, e.func, e.options)
                                : o.addEventListener(i, e.func, e.options),
                            !1)
                        );
                    }
                ));
                            ...
                            this.pendingScripts.push({
                                ...
                                promise: new Promise((e) => {
                                    const i = () => {
                                        ...
                                        i >= 0 &&
                                            this.pendingScripts.splice(i, 1),
                                            e();
                                    };
        ...
        async j() {
            await this.J(),
                this.pendingScripts.length
                    ? (await this.pendingScripts[0].promise, await this.j())
                        ...
                        t.hasAttribute("data-rocket-src")
                            ? t.hasAttribute("async") && !1 !== t.async
                                ...
                                : (t.hasAttribute("defer") && !1 !== t.defer) ||
                                  "module" ===
                                      t.getAttribute("data-rocket-type")
                            ...
                            o !== location.origin &&
                                t.push({
                                    ...
                                    crossOrigin:
                                        e.crossOrigin ||
                                        "module" ===
                                            e.getAttribute("data-rocket-type"),
                                });
                        } catch (t) {}
                    }
                }),
                (t = [
                    ...new Map(t.map((t) => [JSON.stringify(t), t])).values(),
                ]),
                this.N(t, "preconnect");
        }
        async $(t) {
                ...
                return new Promise((e) => {
                    ...
                    try {
                        if (
                            ...
                            i
                                ? ((t.type = i),
                                  t.removeAttribute("data-rocket-type"))
                                ...
                                t.addEventListener(
                                    ...
                                    (i) => {
                                        this.CSPIssue &&
                                        i.target.src.startsWith("data:")
                                            ? (console.log(
                                                  "WPRocket: CSP fallback activated"
                                              ),
        ...
        async C(t) {
            const e = t.shift();
            return e
                ? (e.isConnected && (await this.$(e)), this.C(t))
                : Promise.resolve();
        }
        O() {
            this.N(
        ...
        N(t, e) {
            ...
            t.forEach((t) => {
                const s =
                    (t.getAttribute && t.getAttribute("data-rocket-src")) ||
                    t.src;
            ...
            try {
                await this.G(),
                    document.dispatchEvent(
                        new Event("rocket-readystatechange")
                    ),
                    await this.G(),
                    ...
                    await this.G(),
                    document.dispatchEvent(
                        new Event("rocket-DOMContentLoaded")
                    ),
                    await this.G(),
        ...
        async G() {
            Date.now() - this.lastBreath > 45 &&
                (await this.J(), (this.lastBreath = Date.now()));
        }
        async J() {
