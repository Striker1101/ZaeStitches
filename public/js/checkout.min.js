jQuery(function (e) {
    ...
    var t = {
            ...
            init_payment_methods: function () {
                var o = e(".woocommerce-checkout").find(
                    'input[name="payment_method"]'
                );
            ...
            maybe_update_checkout: function () {
                ...
                if (e(t.dirtyInput).length) {
                    ...
                    r.length &&
                        r.each(function () {
                            "" === e(this).find("input.input-text").val() &&
                                (o = !1);
                        });
                }
            ...
            ship_to_different_address: function () {
                e("div.shipping_address").hide(),
                    e(this).is(":checked") &&
                        e("div.shipping_address").slideDown();
            },
                        ...
                        e(
                            ...
                            t &&
                                ...
                                e("form.checkout_coupon")
                                    ...
                                    .val(""),
                                e("form.checkout_coupon").slideUp(
                                    400,
                                    function () {
                                        e("a.showcoupon").attr(
                                            "aria-expanded",
        ...
        r = {
            ...
            show_login_form: function () {
                return (
                    e("form.login, form.woocommerce-form--login").slideToggle(),
                    !1
                );
            },
        },
        c = {
            ...
            toggle_terms: function () {
                if (e(".woocommerce-terms-and-conditions").length)
                    return (
                        e(".woocommerce-terms-and-conditions").slideToggle(
                            function () {
                                var t = e(
                                    ".woocommerce-terms-and-conditions-link"
                                );
                                e(".woocommerce-terms-and-conditions").is(
                                    ":visible"
                                )
                                    ? (t.addClass(
